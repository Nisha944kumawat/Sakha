...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div className="heroSlider desktopHero">
        {/* ===== FIRST SLIDE ===== */}
        <section className={`hero slide ${activeSlide === 0 ? "active" : ""}`}>
          ...
          <div className="hero__left">
            ...
            <p className="hero__desc">
              Two beloved brands. One promise – spices as pure as your
              grandmother used, grown in India’s finest farms and ground fresh
              for your kitchen.
            </p>
      ...
      <div className="heroSlider mobileHero">
        <section className="hero mobileHeroSingle">
          
          {/* IMAGE SLIDER ONLY */}
          <div className="hero__right mobileSliderImages">

            <img
              alt="Premium Indian spices"
              className={`hero__img-main mobileSlideImg ${
